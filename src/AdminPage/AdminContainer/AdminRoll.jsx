...
import styles from "../AdminContainer/AdminContainerCss/AdminRoll.module.css"

const AdminRoll = () => {
    const [data, setData] = useState([]);

    const getData = () => {
        const url = LOCALHOST_URL + "/roll";
                            ...
                            return (
                                <>
                                    <tr>
                                        ...
                                        <td> <textarea style={{ minWidth: "240px" , maxWidth:"240px", minHeight:"90px", maxHeight:"110px" }} >{item.desc}</textarea></td>
