...
import styles from "../AdminNovelties/AdminNoveltiesCss/AdminNoveltiesDessert.module.css"
import AdminContainer from "../AdminContainer/AdminContainer";

const AdminNoveltiesDessert = () => {
    const [data, setData] = useState([]);

    const getData = () => {
        const url = LOCALHOST_URL + "/newdesert";
...
export default AdminNoveltiesDessert;