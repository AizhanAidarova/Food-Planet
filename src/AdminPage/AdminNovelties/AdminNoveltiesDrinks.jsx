...
import styles from "../AdminNovelties/AdminNoveltiesCss/AdminNoveltiesDrinks.module.css";
import AdminContainer from "../AdminContainer/AdminContainer";

const AdminNoveltiesDrinks = () => {
  const [data, setData] = useState([]);

  const getData = () => {
    const url = LOCALHOST_URL + "/newdrinks";
...
export default AdminNoveltiesDrinks;
