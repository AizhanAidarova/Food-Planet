...
import styles from "../AdminNovelties/AdminNoveltiesCss/AdminNoveltiesSushi.module.css"

const AdminNoveltiesSushi = () => {
    const [data, setData] = useState([]);

    const getData = () => {
        const url = LOCALHOST_URL + "/newsushi";
...
export default AdminNoveltiesSushi;