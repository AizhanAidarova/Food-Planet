...
import styles from "../AdminNovelties/AdminNoveltiesCss/AdminNoveltiesRoll.module.css"

const AdminNoveltiesRoll = () => {
    const [data, setData] = useState([]);

    const getData = () => {
        const url = LOCALHOST_URL + "/newroll";
...
export default AdminNoveltiesRoll;