...
import styles from "../AdminNovelties/AdminNoveltiesCss/AdminNoveltiesBurger.module.css"
import AdminContainer from "../AdminContainer/AdminContainer";

const AdminNoveltiesBurger = () => {
    const [data, setData] = useState([]);

    const getData = () => {
        const url = LOCALHOST_URL + "/newburger";
                            ...
                            return (
                                <>
                                    <tr>
                                        ...
                                        <td><input  style={{ minWidth: "152px" , maxWidth:"152px",textAlign:"center"}} type="text" value={item.name}/></td>
...
export default AdminNoveltiesBurger;