...
import styles from "../AdminNovelties/AdminNoveltiesCss/AdminNoveltiesPizza.module.css"
import AdminContainer from "../AdminContainer/AdminContainer";

const AdminNoveltiesPizza = () => {
    const [data, setData] = useState([]);

    const getData = () => {
        const url = LOCALHOST_URL + "/newpizza";
...
export default AdminNoveltiesPizza;